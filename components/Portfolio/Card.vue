...
<template>
  <article
    class="border bg-white border-brand-black/20 dark:bg-black dark:border-brand-white/20 rounded-lg grid grid-rows-[max-content_1fr_max-content] gap-6 overflow-hidden"
  >
    <!-- Image -->
    <div
