...
<template>
  <article
    class="border bg-brand-white dark:bg-brand-black border-brand-black/20 dark:border-brand-white/20 rounded-lg grid grid-rows-[max-content_1fr_max-content] gap-6 overflow-hidden"
  >
    <!-- Image -->
    <div
